...
DOM (ang.\emph{Document Object Model})
...
\subsection{Serwer serwujący aplikacje internetowe}

\subsubsection{Opis}

\subsubsection{Implementacja}

\subsection{Cechy współczesnej biblioteki programistycznej do tworzenia aplikacji internetowych}
