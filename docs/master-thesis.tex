...
Praca składa się z dziesięciu rozdziałów. Rozdział pierwszy stanowi wstęp. W rodziale drugim przedstawiono sformułowanie problemu. Rozdział trzeci zawiera opis środowiska przeglądarki internetowej, sposób jej działania oraz wykorzystywane technologie. W rozdziale czwartym opisano format danych o nazwie \emph{Trace Event Fomat}. Rozdział piąty zawiera opis zbioru narzędzi o nazwie \emph{Chrone DevTools}. Rozdział szósty przedstawia specyfikacje aplikacji pomagających przy badaniach przeprowadzanych w ramach pracy magisterskiej. W rozdziale siódmym znajduje się opis poszczególnych plaform programistycznych oraz implementacji stworzonych za ich pomocą. Rozdział ósmy zawiera przeprowadzone badania oraz osiągniete wyniki. W rozdziale dziewiątym zawarto porównanie wyników oraz wysunięte wnioski. Ostatni, dzięsiaty rozdział stanowi podsumowanie.
