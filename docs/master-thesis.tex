...
\emph{mihtril.js} jest stosunkowo mało popularną biblioteką w porównaniu do swoich konkurentów. To co go wyróżnia to mała wielkość oraz według swoich twórców lepsza wydajność niż główni konkurenci. Biblioteka ta nie posiada wbudowanego mechanizmu wstrzykiwania zależności. W odróżnieniu od obu bibliotek z rodziny \emph{Angular} posiada mechanizm wirtualnego obiektowego modelu dokumentu. Podobnie jak wszyscy swoi konkurencji pozwala definiować komponenty.
