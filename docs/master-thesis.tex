...
Komponenty mogą przechowywać swój aktualny stan za pomocą prywatnych zmiennych, potrzebnych do poprawnego wyświetlenia oraz działania komponentu. 
...
\begin{center}
  \begin{tabularx}{\textwidth}{|X|X|X|X|X|X|}\hline
    ...
    Rok wydania & 2009 & 2016 & 2013 & 2014 & ??? \\ \hline
    Liczba kontrybutorów w serwisie GitHub & ??? & ??? & ??? & ??? & ??? \\ \hline
    Liczba gwiazdek w serwise GitHub & ??? & ??? & ??? & ??? & ??? \\ \hline
    Kompo- nenty & ??? & ??? & ??? & ??? & ??? \\ \hline
    Wirtualny DOM & Nie & ??? & Tak & ??? & Tak \\ \hline
    Wstrzy- kiwanie zależności & ??? & ??? & ??? & ??? & ??? \\ \hline
  \end{tabularx}
\end{center}
