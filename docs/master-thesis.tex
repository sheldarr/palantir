...
Praca składa się z dziesięciu rozdziałów. Rozdział pierwszy stanowi wstęp. W rodziale drugim przedstawiono sformułowanie problemu. Rozdział trzeci zawiera opis środowiska przeglądarki internetowej, sposób jej działania oraz wykorzystywane technologie. W rozdziale czwartym opisano format danych o nazwie \emph{Trace Event Fomat}. Rozdział piąty zawiera opis zbioru narzędzi o nazwie \emph{Chrone DevTools}. Rozdział szósty przedstawia specyfikacje aplikacji pomagających przy badaniach przeprowadzonych w ramach pracy magisterskiej. W rozdziale siódmym znajduje się opis poszczególnych plaform programistycznych oraz implementacji stworzonych za ich pomocą. Rozdział ósmy zawiera przeprowadzone badania oraz osiągniete wyniki. W rozdziale dziewiątym zawarto porównanie wyników i wysunięte wnioski. Ostatni, dzięsiaty rozdział stanowi podsumowanie.
...
\begin{table}[]
  ...
  Wirtualne maszyny      & 16      & 32      & 48      & 64      & 80      & 96      & 112     & 128     & 144     & 160     & 176     & 192     & 208     & 224     & 240     & 256     \\
