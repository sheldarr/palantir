...
\begin{center}
  \begin{tabularx}{\textwidth}{|X|X|}\hline
    ...
    Zdarzenia z czasem trwania (\emph{ang. duration events}) & \textbf{B} początek (\emph{ang. begin}),\newline
    ...
    Zdarzenia oznaczające (\emph{ang. mark events}) & \textbf{R}\\ \hline
    Zdarzenia synchronizacj zegara (\emph{ang. clock sync events}) & \textbf{c}\\ \hline
